...
This file captures the repository conventions for `guzzlehttp/test-server`. The
organization-wide
...
- `1.0` is the unreleased next major version and `0.6` is the current stable
...
[security policy](https://github.com/guzzle/test-server/security/policy)
instead.
